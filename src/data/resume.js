...
export const cases = [
  {
    slug: 'reporting',
    metric: '24h → 7s',
    metricLabel: 'client report generation, rebuilt',
    client: 'Healthcare client',
    via: 'Penthara Technologies',
    title: 'A day-long report, down to seconds',
    diagram: 'bars',
    problem: 'The client’s data reports took up to 24 hours to generate, so decisions waited a full day on the numbers.',
  ...
  },
  {
    ...
    metric: '0',
    metricLabel: 'manual document uploads left for the client',
...
export const roles = [
  ...
  },
  {
    ...
    cases: ['reporting', 'document-automation', 'penthara'],
    points: [
      'Rebuilt a React + PHP reporting feature for a healthcare client: generation went from 24 hours to 3–7 seconds.',
      'Built Azure Logic Apps and Power Automate flows for an enterprise client that removed manual uploads to Blob Storage and filed SharePoint documents into client-named folders automatically.',
...
export const skills = [
  {
    group: 'Frontend',
    items: [
      { name: 'React.js', used: 'SkillMentor, DevDeck and SkillSync, plus a client reporting feature that went from 24 hours to 3–7 seconds.' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'PHP', used: 'A client reporting feature, rebuilt from 24 hours down to 3–7 seconds, and a React + PHP client platform.' },
  ...
  },
  {
    ...
    items: [
      { name: 'Logic Apps', used: 'Flows for an enterprise client that removed manual document uploads to Azure Blob Storage entirely.' },
      ...
      { name: 'Power Automate', used: 'A SharePoint-to-Blob pipeline for a client and automated email-attachment handling.' },
